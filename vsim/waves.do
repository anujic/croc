...
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/req_i
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/branch_i
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/addr_i
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/ready_i
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/valid_o
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/rdata_o
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/addr_o
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/err_o
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/err_plus2_o
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/instr_req_o
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/instr_gnt_i
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/instr_addr_o
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/instr_rdata_i
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/instr_err_i
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/instr_rvalid_i
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/busy_o
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/valid_new_req
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/valid_req
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/valid_req_d
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/valid_req_q
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/discard_req_d
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/discard_req_q
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/rdata_outstanding_n
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/rdata_outstanding_s
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/rdata_outstanding_q
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/branch_discard_n
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/branch_discard_s
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/branch_discard_q
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/rdata_outstanding_rev
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/stored_addr_d
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/stored_addr_q
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/stored_addr_en
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/fetch_addr_d
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/fetch_addr_q
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/fetch_addr_en
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/instr_addr
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/instr_addr_w_aligned
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/fifo_valid
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/fifo_addr
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/fifo_ready
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/fifo_clear
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/fifo_busy
add wave -noupdate -expand -group {IF Stage} -group {IF Prefetcher} /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/if_stage_i/prefetch_buffer_i/valid_raw
...
add wave -noupdate -expand -group ID /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/fpu_operands
...
add wave -noupdate -expand -group ID /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/rf_fp_we_raw
add wave -noupdate -expand -group ID /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/rf_fp_ren_a
add wave -noupdate -expand -group ID /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/rf_fp_ren_b
add wave -noupdate -expand -group ID /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/rf_fp_ren_c
...
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/illegal_insn_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/ebrk_insn_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/mret_insn_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/dret_insn_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/ecall_insn_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/wfi_insn_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/jump_set_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/instr_first_cycle_i
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/instr_rdata_i
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/instr_rdata_alu_i
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/illegal_c_insn_i
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/imm_a_mux_sel_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/imm_b_mux_sel_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/imm_i_type_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/imm_s_type_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/imm_b_type_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/imm_u_type_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/imm_j_type_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/zimm_rs1_type_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/rf_wdata_sel_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/rf_we_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/rf_raddr_a_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/rf_raddr_b_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/rf_waddr_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/rf_ren_a_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/rf_ren_b_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/rf_fp_wdata_sel_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/rf_fp_we_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/rf_fp_raddr_a_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/rf_fp_raddr_b_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/rf_fp_raddr_c_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/rf_fp_waddr_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/rf_fp_ren_a_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/rf_fp_ren_b_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/rf_fp_ren_c_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/alu_operator_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/alu_op_a_mux_sel_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/alu_op_b_mux_sel_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/alu_multicycle_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/fpu_rnd_mode_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/fpu_op_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/fpu_op_mod_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/fpu_src_fmt_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/fpu_dst_fmt_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/fpu_int_fmt_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/fpu_valid_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/is_fp_dest_id_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/mult_en_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/div_en_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/mult_sel_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/div_sel_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/multdiv_operator_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/multdiv_signed_mode_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/csr_access_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/csr_op_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/data_req_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/data_we_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/data_type_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/data_sign_extension_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/jump_in_dec_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/branch_in_dec_o
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/illegal_insn
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/illegal_reg_rv32e
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/csr_illegal
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/rf_we
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/instr
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/instr_alu
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/unused_instr_alu
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/instr_rs1
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/instr_rs2
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/instr_rs3
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/instr_rd
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/use_rs3_d
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/use_rs3_q
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/csr_op
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/opcode
add wave -noupdate -expand -group ID -group Decoder /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/id_stage_i/decoder_i/opcode_alu
...
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/alu_operator_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/alu_operand_a_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/alu_operand_b_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/alu_instr_first_cycle_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/multdiv_operator_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/mult_en_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/div_en_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/mult_sel_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/div_sel_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/multdiv_signed_mode_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/multdiv_operand_a_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/multdiv_operand_b_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/fpu_operands_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/fpu_rnd_mode_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/fpu_op_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/fpu_op_mod_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/fpu_src_fmt_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/fpu_dst_fmt_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/fpu_int_fmt_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/fpu_in_valid_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/fpu_in_ready_o
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/fpu_flush_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/fpu_status_o
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/fpu_busy_o
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/imd_val_we_o
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/imd_val_d_o
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/imd_val_q_i
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/alu_adder_result_ex_o
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/result_ex_o
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/branch_target_o
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/branch_decision_o
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/ex_valid_o
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/alu_result
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/multdiv_result
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/fpu_result
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/multdiv_alu_operand_b
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/multdiv_alu_operand_a
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/alu_adder_result_ext
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/alu_cmp_result
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/alu_is_equal_result
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/multdiv_valid
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/multdiv_sel
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/fpu_sel
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/alu_imd_val_q
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/alu_imd_val_d
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/alu_imd_val_we
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/multdiv_imd_val_d
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/multdiv_imd_val_we
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/fpu_tag_unused
add wave -noupdate -group EX /tb_croc_soc/i_croc_soc/i_croc/i_core_wrap/i_ibex/ex_block_i/fpu_out_valid
...
WaveRestoreCursors {{Cursor 1} {883577 ns} 0}
...
update
WaveRestoreZoom {882822 ns} {885214 ns}
